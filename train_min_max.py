...
def visualize_input(modalities, writer, global_step):
    ...
    modality_names = ['T1ce', 'T2', 'FLAIR', 'T1']
...
def main():
    ...
    # Setup TensorBoard
    writer = SummaryWriter('runs/3d_unet_experiment_minmax')
    ...
    # Save the model
    torch.save(model.state_dict(), 'unet3d_model_minmax.pth')
    ...
    with open('patient_minmax_params.json', 'w') as f:
        json.dump(normalization_params, f)

    # Save average normalization parameters
    with open('avg_minmax_params.json', 'w') as f:
